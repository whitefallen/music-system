...
1. **Narrative Magnetism**
   Hierarchy induces story. Story induces progression. Progression induces resolution.

2. **Moral Optimization**
   Once value is introduced, outputs are optimized toward judgment, meaning, or message.

3. **Observer Re-Centering**
   Ontological priority implicitly reintroduces a human or interpretive witness.

4. **AI Bias Amplification**
   Generative models preferentially reinforce moral contrast and agent-centered framing.
