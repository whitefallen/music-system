...
1. **Memory Dependence**
   Decisions are stored implicitly in taste, intuition, or momentary judgment.

2. **Inconsistent Criteria**
   Evaluation shifts between iterations, eroding coherence.

3. **Over-Attachment**
   Outputs become defended emotionally rather than assessed structurally.

4. **AI Reinforcement Bias**
   Generative models optimize toward impressive artifacts, masking systemic flaws.
