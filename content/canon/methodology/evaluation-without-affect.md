---
title: "Evaluation Without Affect"
type: methodology
status: canon
layer: canon
version: 1.0
...
1. **Emotional Anchoring**
   Initial reactions bias subsequent judgment.

2. **Inconsistency Over Time**
   Mood and context alter evaluation criteria.

3. **Output Attachment**
   Positive affect increases tolerance for violations.

4. **AI Persuasion Bias**
   Generative systems optimize for affective impact.
