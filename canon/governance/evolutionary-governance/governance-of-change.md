...
1. **Silent Drift**
   Small adjustments accumulate without record or intent.

2. **Retroactive Rationalization**
   Past decisions are reinterpreted to fit present preferences.

3. **Memory Loss**
   Reasons for constraints are forgotten, weakening enforcement.

4. **AI-Driven Mutation**
   Generative output subtly reshapes rules through repeated exposure.
...
1. Identify contradiction or failure
2. Document issue in lab
3. Propose modification
4. Assess systemic impact
5. Version and apply change
