...
1. **Audience Optimization**
   Outputs drift toward legibility, affect, and accessibility.

2. **Relevance Pressure**
   Systems are bent to feel timely, meaningful, or communicative.

3. **Feedback Dependency**
   Iteration becomes driven by reaction rather than compliance.

4. **AI Bias Amplification**
   Generative models privilege human-scale drama, emotion, and narrative.
