...
1. **Author Dependence**
   Expressive systems rely on the continued presence, memory, and coherence of an individual.

2. **Narrative Gravity**
   Expression pulls output toward story, development, and resolution.

3. **Evaluation Collapse**
   Success becomes subjective (“it feels right”), eliminating reproducibility.

4. **AI Bias Amplification**
   Generative models strongly favor expressive completion (emotion, uplift, climax).
