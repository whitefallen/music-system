...
1. **Taste Drift**
   Evaluation shifts subtly over time, eroding coherence.

2. **Post-Hoc Justification**
   Rules are bent to accommodate outputs that feel compelling.

3. **Inconsistent Memory**
   Decisions depend on recall rather than documentation.

4. **AI Quality Illusion**
   High-fidelity outputs mask systemic violations.
