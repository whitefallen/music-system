...
1. **Rule Erosion**
   Attempted fixes implicitly redefine constraints.

2. **Output Attachment**
   Time invested becomes a reason to keep non-compliant artifacts.

3. **Hidden Exceptions**
   Repairs normalize violations as edge cases.

4. **AI Fluency Masking**
   Generative polish disguises structural faults.
